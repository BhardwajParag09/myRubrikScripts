...
#DATE FORMAT EXAMPLE: "2022-08-05T18:30:00.000Z"
beforeDate = "2022-08-05T18:30:00.000Z"
afterDate = "2022-08-12T18:30:00.000Z"
...
baseurl = '/event/csv_download_link?event_type={}&before_date={}&after_date={}'
url = baseurl.format(event_type, beforeDate, afterDate)
r = rubrik.get('v1', url)
t = json.dumps(r)
final = json.loads(t)
